...
import { addorupdatemachine, getallplatforms } from '../../actions/adminAuthAction'
...
export default withRouter(connect(mapStateToProps, { addorupdatemachine, setAlert, getallplatforms })(AddorUpdateMachine))