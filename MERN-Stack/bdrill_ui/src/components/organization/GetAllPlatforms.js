...
import { getallplatforms } from '../../actions/adminAuthAction'
...
export default (connect(mapStateToProps, { setAlert, getallplatforms })(GetAllPlatforms))