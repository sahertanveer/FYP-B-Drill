...
const CandNavigation = ({ auth: { isAuthenticated, loading }, logout, setPage, loadUser, page: { loadedPage } }) => {
...
export default connect(mapStateToProps, { logout, setPage, loadUser })(CandNavigation)