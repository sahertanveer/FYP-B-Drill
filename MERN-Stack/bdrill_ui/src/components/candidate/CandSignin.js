...
import { login } from '../../actions/candidateAuthAction'
import Alert from '../../layout/Alert'

const CandSignin = ({ login, isAuthenticated, role }) => {
  ...
  if (isAuthenticated && role === "candidate") {
    return <Redirect to='/canddashboard' />
  }

  return (
    <BrowserRouter>
      {/* <Route path="/candnavigation" component={CandNavigation} /> */}
...
export default connect(mapStateToProps, { login })(CandSignin)
