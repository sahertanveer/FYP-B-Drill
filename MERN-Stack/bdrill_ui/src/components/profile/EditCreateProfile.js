            ...
            <div className="container-fluid uicards">
                <div className="row">
                    <div className="col s12 m12 l12">
                        <h3 className="card-stats-number" style={{ fontFamily: "Princess Sofia" }}>Profile</h3>
                        <p className="red-text"> &nbsp;* = required field </p>
                        <hr />
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="col s12 m12 l12">
                        <form className="form" onSubmit={onSubmit}>
                            <h4 className=" bg-light white-text center">Personal Information</h4>
                            ...
                            <h4 className=" bg-light white-text center">Other Information</h4>
                            <div className="grey darken-4" style={{padding:"20px"}}>
                            <div className="row form-group">
                                <div className="col s4 m3 l2">
                                    <label className="right control-label white-text"
                            ...
                            <div className="my-2">
                                <h4 className=" bg-light white-text center">Education Information</h4>
                                <span className="grey-text">Click on button to add education information</span>
                            </div>


                            <button type="button" className="btn btn-danger" onClick={() => handleEducationAdd()}>
                                +
                        </button>
                            ...
                            <div className="my-2">
                                <h4 className=" bg-light white-text center">Experience Information</h4>
                                <span className="grey-text">Click on button to add experience</span>
                            </div>
                            <button type="button" className="btn btn-danger" onClick={() => handleExperienceAdd()}>
                                +
                             </button>
